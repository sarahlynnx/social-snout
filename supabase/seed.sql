...
-- (swiper_id, swiper_pet_id, pet_id, direction) — swiper_pet_id is WHICH of the
-- user's pets did the swiping (per-pet decks, migration 017).
INSERT INTO swipes (swiper_id, swiper_pet_id, pet_id, direction) VALUES
  -- Buddy <-> Mochi
  ('a1111111-1111-1111-1111-111111111111', 'b1111111-1111-1111-1111-111111111111', 'b3333333-3333-3333-3333-333333333333', 'RIGHT'),
  ('a2222222-2222-2222-2222-222222222222', 'b3333333-3333-3333-3333-333333333333', 'b1111111-1111-1111-1111-111111111111', 'RIGHT'),
  -- Buddy <-> Kiko
  ('a1111111-1111-1111-1111-111111111111', 'b1111111-1111-1111-1111-111111111111', 'b4444444-4444-4444-4444-444444444444', 'RIGHT'),
  ('a3333333-3333-3333-3333-333333333333', 'b4444444-4444-4444-4444-444444444444', 'b1111111-1111-1111-1111-111111111111', 'RIGHT'),
  -- Luna <-> Bear
  ('a1111111-1111-1111-1111-111111111111', 'b2222222-2222-2222-2222-222222222222', 'b5555555-5555-5555-5555-555555555555', 'RIGHT'),
  ('a3333333-3333-3333-3333-333333333333', 'b5555555-5555-5555-5555-555555555555', 'b2222222-2222-2222-2222-222222222222', 'RIGHT'),
  -- Mochi <-> Rosie
  ('a2222222-2222-2222-2222-222222222222', 'b3333333-3333-3333-3333-333333333333', 'b6666666-6666-6666-6666-666666666666', 'RIGHT'),
  ('a4444444-4444-4444-4444-444444444444', 'b6666666-6666-6666-6666-666666666666', 'b3333333-3333-3333-3333-333333333333', 'RIGHT'),
  -- Chai <-> Pepper
  ('a5555555-5555-5555-5555-555555555555', 'b7777777-7777-7777-7777-777777777777', 'b8888888-8888-8888-8888-222222222222', 'RIGHT'),
  ('a6666666-6666-6666-6666-666666666666', 'b8888888-8888-8888-8888-222222222222', 'b7777777-7777-7777-7777-777777777777', 'RIGHT'),
  -- Scout <-> Yuki
  ('a9999999-9999-9999-9999-999999999999', 'bb000000-0000-0000-0000-111111111111', 'ba000000-0000-0000-0000-111111111111', 'RIGHT'),
  ('a8888888-8888-8888-8888-888888888888', 'ba000000-0000-0000-0000-111111111111', 'bb000000-0000-0000-0000-111111111111', 'RIGHT'),
  -- Some left swipes for realism
  ('a4444444-4444-4444-4444-444444444444', 'b6666666-6666-6666-6666-666666666666', 'b4444444-4444-4444-4444-444444444444', 'LEFT'),
  ('a2222222-2222-2222-2222-222222222222', 'b3333333-3333-3333-3333-333333333333', 'b2222222-2222-2222-2222-222222222222', 'LEFT'),
  ('a6666666-6666-6666-6666-666666666666', 'b8888888-8888-8888-8888-111111111111', 'b9999999-9999-9999-9999-111111111111', 'LEFT'),
  ('a5555555-5555-5555-5555-555555555555', 'b7777777-7777-7777-7777-777777777777', 'bc000000-0000-0000-0000-222222222222', 'LEFT')
